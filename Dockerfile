...
RUN apt-get update && \
	...
	apt-get install -y --no-install-recommends \
		...
		tcpdump \
		pkgconf libmnl-dev libxtables-dev libatm1-dev libbsd-dev libbpf-dev libc6-dev-i386 libcap-dev libdb-dev libnsl-dev libselinux1-dev zlib1g-dev \
